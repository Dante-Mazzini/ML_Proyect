...
(accuracy, other_accuracy) = p1.classifier_accuracy(p1.pegasos,train_bow_features,test_bow_features,train_labels,test_labels,T=25,L=0.01)
...
print('the accuracy on the test set is: ', other_accuracy)
